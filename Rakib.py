...
prinCP=[]
try:
    prox= requests.get('https://github.com/Sakib051325/Aprbol/blob/main/Aprbol').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Sakib051325/Aprbol/blob/main/Aprbol').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get(‘https://github.com/Sakib051325/Aprbol/blob/main/Aprbol').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801732370826?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Sakib051325/Aprobl/tree/main')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
